...
from app import db
from . models import *
from utils import int_to_str_duration
...
def page_perfomances():
    ...
    result = dict()
    perf_query = Perfomances.query.filter(Perfomances.id.in_([page_num*per_page_num, page_num*per_page_num+per_page_num])).all() 
